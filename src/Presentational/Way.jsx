...
export default class Way extends React.Component {
				...
				<Table>
					<TableBody>
						<TableRow>
							...
							<TableCell>
								<div>Fecha de envío: 25/07/17 09:00 am</div>
								<div>Tiempo estimado: 12 horas</div>
							</TableCell>
							<TableCell> 
								<Button className="send-button" style={{width: '30%'}} raised>Recibido
								</Button> 
							</TableCell>
						</TableRow>
					</TableBody>
